...
```{r}
twohundred_progression <- wikipedia_table_scrape(url = "https://en.wikipedia.org/wiki/Men%27s_200_metres_world_record_progression",
...
```{r}
fourhundred_progression <- wikipedia_table_scrape(url = "https://en.wikipedia.org/wiki/Men%27s_400_metres_world_record_progression",
                       xpath = '//*[@id="mw-content-text"]/div[1]/table[1]')
```
...
```{r}
mile_progression <- readxl::read_excel("/Users/dunk/Github/Athletics/Men's Mile Run Record Progression.xlsx")
...
```{r}
recordslist <- list(world_record_100_clean, twohundred_progression)
```
