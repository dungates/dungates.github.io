...
```{r include = F}
knitr::opts_chunk$set(echo = F, message = F, warning = F, fig.align = 'center', fig.width = 20, fig.height = 10)
library(rvest)
library(xml2)
library(tidyverse)
library(hrbrthemes)
...
mens_world_records_seconds <- readxl::read_excel("/Users/dunk/Projects/Athletics/mens_world_records.xlsx", range = "B1:G46")
womens_world_records_seconds <- readxl::read_excel("/Users/dunk/Projects/Athletics/womens_world_records.xlsx", range = "B1:G50")
